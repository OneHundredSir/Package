...
@interface CAViewController ()<UITableViewDelegate,UITableViewDataSource,ZZBrowserPickerDelegate,UICollectionViewDataSource,UICollectionViewDelegate>
...
-(instancetype)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        self.navigationItem.title = @"香蕉大大";
    }
    return self;
}
